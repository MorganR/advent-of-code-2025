# advent-of-code-2025 - Lua

Advent of Code solutions for 2025, written in Lua.

This only contains code for days 1 and 2, which was sufficient for me to learn some Lua, and also decide **not** to do the rest of the days in Lua.
