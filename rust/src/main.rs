...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    match (args.day, args.part) {
        ...
        (9, 2) => {
            let largest_area = days::day9::part2(&input)?;
            println!("Largest area: {}", largest_area);
            Ok(())
        }
        (10, 1) => {
            let num_presses = days::day10::part1(&input)?;
        ...
        (11, 1) => {
            let result = days::day11::part1(&input)?;
        ...
        (12, 1) => {
            let result = days::day12::part1(&input)?;
            println!("Number of packable trees: {}", result);
            Ok(())
        }
